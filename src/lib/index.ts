...
const useUploadThing = <TRouter extends FileRouter>(
...
export const generateSvelteKitHelpers = <
    TRouter extends FileRouter,
>(): SvelteKitHelpers<TRouter> => {
    return {
        useUploadThing,
...
type UploadThing<TRouter extends FileRouter> = (
    endpoint: keyof TRouter extends string ? keyof TRouter : string,
) => {
